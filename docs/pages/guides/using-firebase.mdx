...
**At this point, you must follow the instructions from [React Native Firebase documentation](https://rnfirebase.io/#expo)** as it covers all the steps required to configure your project with the library.
